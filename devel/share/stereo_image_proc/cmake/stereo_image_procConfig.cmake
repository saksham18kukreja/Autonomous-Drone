...
if("TRUE" STREQUAL "TRUE")
  set(stereo_image_proc_SOURCE_PREFIX /home/saksham/iris_quad/src/image_pipeline/stereo_image_proc)
  set(stereo_image_proc_DEVEL_PREFIX /home/saksham/iris_quad/devel)
  ...
  set(stereo_image_proc_INSTALL_PREFIX /home/saksham/iris_quad/install)
...
if(NOT "/home/saksham/iris_quad/devel/include;/home/saksham/iris_quad/src/image_pipeline/stereo_image_proc/include " STREQUAL " ")
  set(stereo_image_proc_INCLUDE_DIRS "")
  set(_include_dirs "/home/saksham/iris_quad/devel/include;/home/saksham/iris_quad/src/image_pipeline/stereo_image_proc/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'stereo_image_proc' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/saksham/iris_quad/src/image_pipeline/stereo_image_proc/${idir}'.  ${_report}")
    endif()
