...
class RRT(object):
    ...
    def check_obstacle(self,point1):
        for point2 in self.Obstacles:
            if (self.getDistance(point1,point2)<=self.drone_len):
                return False
            else:
                continue    
        return True        
    ...
    def getOptimal(self):
        ...
        return [(point.x,point.y,point.z) for point in self.optimal]
