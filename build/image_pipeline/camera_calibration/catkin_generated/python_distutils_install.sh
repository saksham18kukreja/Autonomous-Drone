...
echo_and_run cd "/home/saksham/iris_quad/src/image_pipeline/camera_calibration"
...
echo_and_run /usr/bin/env \
    ...
    egg_info --egg-base /home/saksham/iris_quad/build/image_pipeline/camera_calibration \
    build --build-base "/home/saksham/iris_quad/build/image_pipeline/camera_calibration" \
    install \
    --root="${DESTDIR-/}" \
